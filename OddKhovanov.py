...
def zCoefficient(khovanovGenerators, gradings, signedFlowCategory, matchings, z):
    ...
    for K in cycleSet:
        #print('K:', K)
        yPositions = tuple(signedFlowCategory.nPlusOneGeneratorDict[K[i][0][1]][0] for i in range(len(K))) #actual coordinates of the y's on the cube
        #print(yPositions)
        ...
        for i in range(cLength): #Adds the products of adjacencies
            ...
            if sorted(triple)[1] == triple[1]:
                if (triple[2]-triple[0]) % 2 == 1 and (((selectedEdge in edgeAssignmentSet) + ((K[(i+1)%cLength][0][1],z) in oddArrowYZSet)) % 2 == 1) :
                    KElement += 1
            else:
                if (triple[2]-triple[0]) % 2 == 0 and (((selectedEdge in edgeAssignmentSet) + ((K[(i+1)%cLength][0][1],z) in oddArrowYZSet)) % 2 == 1):
                    KElement += 1
...
def Sq2(khovanovGenerators, gradings, signedFlowCategory, kernel):
    ...
    #print(khovanovGenerators.hqToSparseMatrix[gradings[0]+2, gradings[1]]*Sq2Set)
    return Sq2Set
...
basicDict = (((1,2),0), ((1,2),'-'), ((1,2), 1))
#testDict = (((1,2),0), ((1,2), '+'), ((3,4),0), ((2,3),1), ((2,3),0),  ((1,2),'+'), ((3,4),'+'), ((2,3),1), ((1,4),1))
ladybugDict = (((1,2),0),((3,4),0),((2,3),'+'),((2,3),'-'),((1,2),1),((3,4),1))
...
perkoPair161 = (((1,6),0),((7,8),0),((9,10),0),((6,7),'-'),((8,9),'-'),((2,3),0),((4,5),0),((7,8),1),((1,2),'-'),((3,4),'-'),((7,8),0),((9,10),'+'),((6,7),'-'),((5,6),1),((4,7),'-'),((7,8),'+'),((2,3),1),((4,7),'+'),((4,7),'+'),((8,9),1),((1,4),1),((7,10),1))
perkoTable1 = (((1, 2), 0), ((6, 3), 0), ((2, 3), "+"), ((5, 4), 0), ((3, 4), "+"), ((2, 3), "+"), ((4, 5), "-"), ((5, 6), "-"), ((1, 2), "-"), ((2, 3), "-"), ((2, 3), "-"), ((3, 4), 1), ((2, 5), "+"), ((1, 2), "-"), ((2, 5), 1), ((6, 1), 1))
perkoTable2 = (((1, 2), 0), ((4, 3), 0), ((2, 3), "+"), ((6, 5), 0), ((4, 5), "-"), ((3, 4), "-"), ((5, 6), "+"), ((2, 3), "+"), ((3, 4), "+"), ((3, 4), "+"), ((4, 5), 1), ((2, 3), "+"), ((2, 3), "+"), ((2, 3), "+"), ((2, 1), 1), ((3, 6), 1))
linkDict = linkL6n1Dict
