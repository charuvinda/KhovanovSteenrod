...
class morseLink:
    def __init__(self, moveTuple):#input (positiveCrossingNo, negativeCrossingNo)
        ...
        widths = set() #we build our set of widths (rows)
        for n in range(moveNo):
            for i in self.moveTuple[n][0]:
                widths.add(i)
        movesWidthI = dict()#movesWidthI tell us which moves involve crossing i
        for i in widths:
            movesWidthI[i] = set()
        for n in range(moveNo):
...
knot4_1ConnectSumDict = (((1,2),0), ((3,4),0), ((2,3),'-'), ((2,3),'-'), ((3,4),'+'), ((3,4),'+'), ((2,3),1), ((5,6),0), ((4,5),'-'), ((4,5),'-'), ((5,6),'+'), ((5,6),'+'), ((4,5),1),((1,6),1), ((1,2),0), ((1,2),1))
linkL6n1Dict = (((1,4),0), ((5,6), 0), ((2,3), 0), ((4,5),'-'), ((1,2),'+'), ((3,4),'+'), ((2,3),'+'), ((1,2),'-'), ((3,4),'-'), ((2,3),1), ((4,5),1), ((1,6),1))
linkL6n1MirrorDict = (((1,4),0), ((5,6), 0), ((2,3), 0), ((4,5),'+'), ((1,2),'-'), ((3,4),'-'), ((2,3),'-'), ((1,2),'+'), ((3,4),'+'), ((2,3),1), ((4,5),1), ((1,6),1))
